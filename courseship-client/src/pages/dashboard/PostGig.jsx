// src/pages/dashboard/PostGig.jsx
    ...
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="number" className="form-control" name="stipend" value={form.stipend} onChange={handleChange} required />
        </div>
